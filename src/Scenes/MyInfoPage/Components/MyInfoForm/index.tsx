      ...
      <div className="myInfoForm">
        ...
        <div className="row form-group">
          <div className="col-xs-6 col-sm-6 col-md-6 yearOfBirth">
            ...
            <div className="selectItem">
              <SelectComponent selected={undefined} onSelect={() => { return; }} listItem={this.yearOfBirth} />
            </div>
          </div>
        ...
        <div className="row form-group">
          ...
          <div className="form-group col-xs-12 col-sm-4 col-md-2">
            ...
            <SelectComponent selected={undefined} onSelect={() => { return; }} listItem={this.propertyType} />
          </div>
          <div className="form-group col-xs-12 col-sm-4 col-md-2">
            <h4 className="hidden-xs hidden-sm invisible">Beds</h4>
            <SelectComponent selected={undefined} onSelect={() => { return; }} listItem={this.bedProperty} />
          </div>
          <div className="form-group col-xs-12 col-sm-4 col-md-2">
            <h4 className="hidden-xs hidden-sm invisible">Own Or Rent</h4>
            <SelectComponent selected={undefined} onSelect={() => { return; }} listItem={this.ownOrRent} />
          </div>
        </div>
